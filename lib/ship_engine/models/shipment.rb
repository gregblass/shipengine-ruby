...
module ShipEngine
  ...
  class Shipment
    ...
    def hash
      [shipment_id, carrier_id, service_code, external_shipment_id, ship_date, created_at, modified_at, shipment_status, ship_to, ship_from, warehouse_id, return_to, confirmation, customs, advanced_options, insurance_provider, tags, total_weight, packages].hash
    end
