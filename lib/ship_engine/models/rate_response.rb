...
module ShipEngine
  ...
  class RateResponse
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ["working", "completed", "partial", "error"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["working", "completed", "partial", "error"])
    ...
    def hash
      [rates, invalid_rates, errors, rate_request_id, shipment_id, created_at, status].hash
    end
