...
module ShipEngine
  ...
  class CreateShipmentResponse
    ...
    def self.ship_engine_types
      {
        :'errors' => :'Array<String>',
        :'address_validation' => :'AddressValidationResponseDTO',
        :'shipment_id' => :'String',
        :'carrier_id' => :'String',
        :'service_code' => :'String',
    ...
    def hash
      [errors, address_validation, shipment_id, carrier_id, service_code, external_shipment_id, ship_date, created_at, modified_at, shipment_status, ship_to, ship_from, warehouse_id, return_to, confirmation, customs, advanced_options, insurance_provider, tags, total_weight, packages].hash
    end
