...
# Unit tests for ShipEngine::PurchaseLabelWithoutShipmentRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PurchaseLabelWithoutShipmentRequest' do
  before do
    # run before each test
    @instance = ShipEngine::PurchaseLabelWithoutShipmentRequest.new
  end
  ...
  describe 'test an instance of PurchaseLabelWithoutShipmentRequest' do
    it 'should create an instance of PurchaseLabelWithoutShipmentRequest' do
      expect(@instance).to be_instance_of(ShipEngine::PurchaseLabelWithoutShipmentRequest)
    end
  end
