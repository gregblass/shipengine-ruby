...
# Unit tests for ShipEngineApi::PurchaseLabelRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PurchaseLabelRequest' do
  before do
    # run before each test
    @instance = ShipEngineApi::PurchaseLabelRequest.new
  end
  ...
  describe 'test an instance of PurchaseLabelRequest' do
    it 'should create an instance of PurchaseLabelRequest' do
      expect(@instance).to be_instance_of(ShipEngineApi::PurchaseLabelRequest)
    end
  end
