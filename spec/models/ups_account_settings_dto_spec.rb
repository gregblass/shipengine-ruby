...
# Unit tests for ShipEngine::UPSAccountSettingsDTO
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UPSAccountSettingsDTO' do
  before do
    # run before each test
    @instance = ShipEngine::UPSAccountSettingsDTO.new
  end
  ...
  describe 'test an instance of UPSAccountSettingsDTO' do
    it 'should create an instance of UPSAccountSettingsDTO' do
      expect(@instance).to be_instance_of(ShipEngine::UPSAccountSettingsDTO)
    end
  end
